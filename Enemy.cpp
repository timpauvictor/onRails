  ...
  glPushMatrix();
     glTranslated(x,y,z);
      ...
      glPushMatrix();
        ...
        glPushMatrix();
          glTranslatef(0,0,-1*radius+0.3*radius);
          glColor3f(1,0,0);
          glutSolidSphere(0.4*radius,10,100);
        glPopMatrix();
        ...
        glPushMatrix();
        //Torus
          glTranslatef(0,0,-1*radius + 0.2*radius );
          glutSolidTorus(0.7*radius/5,0.7*radius/5 + 0.2*radius,50,50);
        glPopMatrix();
        ...
        glPushMatrix();
          glTranslatef(0.7*radius,0.5*radius,-0.2*radius);
          glScalef(0.3,0.3,2);
          glColor3f(0,1,0);
          glutSolidCube(1*radius);
        glPopMatrix();
